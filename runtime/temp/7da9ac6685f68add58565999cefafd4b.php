<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:67:"D:\phpStudy\WWW\SupporttingProject/app/admin\view\teacher\index.php";i:1536830530;s:60:"D:\phpStudy\WWW\SupporttingProject\app\admin\view\layout.php";i:1536553919;s:66:"D:\phpStudy\WWW\SupporttingProject\app\admin\view\block\header.php";i:1536553919;s:64:"D:\phpStudy\WWW\SupporttingProject\app\admin\view\block\menu.php";i:1536553919;s:65:"D:\phpStudy\WWW\SupporttingProject\app\admin\view\block\layui.php";i:1536553919;s:66:"D:\phpStudy\WWW\SupporttingProject\app\admin\view\block\footer.php";i:1536553919;}*/ ?>
...
<?php endif; switch($tab_type): case "1": ?>
    ...
    <div class="layui-btn-group fl">
        <a href="<?php echo url('addTeacher'); ?>" class="layui-btn layui-btn-primary layui-icon layui-icon-add-circle-fine">&nbsp;添加</a>
        <a data-href="<?php echo url('status?table=admin_teacher&val=1'); ?>" class="layui-btn layui-btn-primary j-page-btns layui-icon layui-icon-play" data-table="dataTable">&nbsp;启用</a>
        <a data-href="<?php echo url('status?table=admin_teacher&val=0'); ?>" class="layui-btn layui-btn-primary j-page-btns layui-icon layui-icon-pause" data-table="dataTable">&nbsp;禁用</a>
        <a data-href="<?php echo url('delTeacher'); ?>" class="layui-btn layui-btn-primary j-page-btns confirm layui-icon layui-icon-close red">&nbsp;删除</a>
    </div>
</div>
...
<script type="text/html" title="操作按钮模板" id="buttonTpl">
    <a href="<?php echo url('editTeacher'); ?>?id={{ d.id }}" class="layui-btn layui-btn-xs layui-btn-normal">修改</a>
    <a href="<?php echo url('delTeacher'); ?>?id={{ d.id }}" class="layui-btn layui-btn-xs layui-btn-danger j-tr-del">删除</a>
</script>
