...
<div class="layui-tab-item layui-show layui-form-pane">
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="text" class="layui-input field-teacher_name" name="teacher_name" lay-verify="required" autocomplete="off" placeholder="请输入教师姓名" value="<?php echo $teacher_name; ?>">
        </div>
    </div>
    <div class="layui-form-item">
    ...
    <div class="layui-form-item studenthomelink">
        ...
        <div class="layui-input-inline" style="width:90px">
            <input type="text" class="layui-input field-name" name="name[]" lay-verify="required" autocomplete="off" placeholder="姓名" value="<?php echo $vo['name']; ?>">
        </div>
        <label class="layui-form-label">亲属关系</label>
        <div class="layui-input-inline" style="width:90px">
            <input type="text" class="layui-input field-homerelation" name="homerelation[]" lay-verify="required" autocomplete="off" placeholder="亲属关系" value="<?php echo $vo['homerelation']; ?>">
        </div>
        <label class="layui-form-label">年龄</label>
        <div class="layui-input-inline" style="width:90px">
            <input type="text" class="layui-input field-birthday" name="age[]" lay-verify="required" autocomplete="off" placeholder="年龄" value="<?php echo $vo['age']; ?>">
        </div>
...
或家庭所在地" value="<?php echo $vo['workaddress']; ?>">
        ...
        <div class="layui-input-inline" style="width:100px">
            <input type="text" class="layui-input field-mobile" name="mobile[]" lay-verify="required" autocomplete="off" placeholder="联系电话" value="<?php echo $vo['mobile']; ?>">
        </div>
