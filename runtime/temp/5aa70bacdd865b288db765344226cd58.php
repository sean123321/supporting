<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:59:"D:\wwwroot\xszzglzx\wwwroot/app/admin\view\school\index.php";i:1538657168;s:53:"D:\wwwroot\xszzglzx\wwwroot\app\admin\view\layout.php";i:1538657145;s:59:"D:\wwwroot\xszzglzx\wwwroot\app\admin\view\block\header.php";i:1538657139;s:57:"D:\wwwroot\xszzglzx\wwwroot\app\admin\view\block\menu.php";i:1538657140;s:58:"D:\wwwroot\xszzglzx\wwwroot\app\admin\view\block\layui.php";i:1538657140;s:59:"D:\wwwroot\xszzglzx\wwwroot\app\admin\view\block\footer.php";i:1538657139;}*/ ?>
...
<?php endif; switch($tab_type): case "1": ?>
    ...
    <div class="layui-btn-group fl">
        <a href="<?php echo url('addSchool'); ?>" class="layui-btn layui-btn-primary layui-icon layui-icon-add-circle-fine">&nbsp;添加</a>
        <a data-href="<?php echo url('status?table=admin_school&val=1'); ?>" class="layui-btn layui-btn-primary j-page-btns layui-icon layui-icon-play" data-table="dataTable">&nbsp;启用</a>
        <a data-href="<?php echo url('status?table=admin_school&val=0'); ?>" class="layui-btn layui-btn-primary j-page-btns layui-icon layui-icon-pause" data-table="dataTable">&nbsp;禁用</a>
        <a data-href="<?php echo url('delSchool'); ?>" class="layui-btn layui-btn-primary j-page-btns confirm layui-icon layui-icon-close red">&nbsp;删除</a>
    </div>
</div>
...
<script type="text/html" id="statusTpl">
    <input type="checkbox" name="status" value="{{ d.status }}" lay-skin="switch" lay-filter="switchStatus" lay-text="正常|关闭" {{ d.status == 1 ? 'checked' : '' }} data-href="<?php echo url('status'); ?>?table=admin_school&id={{ d.id }}">
</script>
<script type="text/html" title="操作按钮模板" id="buttonTpl">
    <a href="<?php echo url('editSchool'); ?>?id={{ d.id }}" class="layui-btn layui-btn-xs layui-btn-normal">修改</a>
    <a href="<?php echo url('delSchool'); ?>?id={{ d.id }}" class="layui-btn layui-btn-xs layui-btn-danger j-tr-del">删除</a>
</script>
