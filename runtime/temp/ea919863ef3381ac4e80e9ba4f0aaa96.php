...
<?php endif; switch($tab_type): case "1": ?>
    ...
    <div class="layui-btn-group fl">
        <a href="<?php echo url('addStudent'); ?>" class="layui-btn layui-btn-primary layui-icon layui-icon-add-circle-fine">&nbsp;添加</a>
        <a data-href="<?php echo url('delStudent'); ?>" class="layui-btn layui-btn-primary j-page-btns confirm layui-icon layui-icon-close red">&nbsp;删除</a>
    </div>
</div>
...
<script type="text/html" title="操作按钮模板" id="buttonTpl">
    <a href="<?php echo url('showStudent'); ?>?id={{ d.id }}" class="layui-btn layui-btn-xs layui-btn-normal">查看</a>
    <a href="<?php echo url('editStudent'); ?>?id={{ d.id }}" class="layui-btn layui-btn-xs layui-btn-normal">修改</a>
    <a href="<?php echo url('delStudent'); ?>?id={{ d.id }}" class="layui-btn layui-btn-xs layui-btn-danger j-tr-del">删除</a>
</script>
