...
class User extends Admin
{
    ...
    public function addUser()
    {
        ...
        $this->assign('school_option', SchoolModel::getOption());
    ...
    public function editUser($id = 0)
    {
        ...
        $row = UserModel::where('id', $id)->field('id,username,school_id,role_id,nick,email,mobile,auth,status')->find()->toArray();
        if (!$row['auth']) {
        ...
        $this->assign('school_option', SchoolModel::getOption($row['school_id']));
